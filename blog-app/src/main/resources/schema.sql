CREATE EXTENSION IF NOT EXISTS "uuid-ossp"; -- This is required to enable
UUID extension
...
drop table if exists "user" cascade; -- since user is a keyword in
postgresql, double quotes are used here
...
create table comment_like (id bigserial not null, comment_id int8, post_id
